...
namespace OODProject
{
    ...
    public partial class manageBooking : Form
    {
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "insert into [dbo].[Booking](bookingDate, seatNumber , flightID, userID) values(@date, @seat, @flight, @user)";
        ...
        private void manageGrid_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (manageGrid.Rows[e.RowIndex].Cells[0].Value != DBNull.Value)
            {
                ...
                seatTextBox.Text = manageGrid.Rows[e.RowIndex].Cells[2].Value.ToString();
                datePicker.Value = DateTime.Parse(manageGrid.Rows[e.RowIndex].Cells[1].Value.ToString());
